...
int main() {
  ...
  int verticalMeasurements[n] = {0, 10, 10, 2, 2, 2, 2, 10, 10, 0};
  ...
  int horizontalMeasurements[n] = {4, 4, 4, 4, 8, 8, 4, 4, 4, 4};
  ...
  int diagonalMeasurements[2*n - 1] = {0, 1, 2, 2, 2, 2, 2, 4, 6, 6, 6, 4, 2, 2, 2, 2, 2, 1, 0};
  ...
  int antiDiagonalMeasurements[2*n - 1] = {0, 1, 2, 2, 2, 2, 2, 4, 6, 6, 6, 4, 2, 2, 2, 2, 2, 1, 0};
  ...
  short binaryGray[N][N];
    ...
    Display binaryImage(binaryGray, "Case3Thresholded");
