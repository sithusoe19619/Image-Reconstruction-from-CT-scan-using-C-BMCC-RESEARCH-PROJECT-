...
int main() {
  ...
  int verticalMeasurements[n] = {0, 2, 2, 2, 10, 10, 2, 2, 2, 0};
  ...
  int horizontalMeasurements[n] = {8, 8, 2, 2, 2, 2, 2, 2, 2, 2};
  ...
  int diagonalMeasurements[2*n - 1] = {0, 0, 0, 0, 1, 2, 2, 2, 2, 3, 4, 4, 3, 2, 2, 2, 2, 1, 0};
  ...
  int antiDiagonalMeasurements[2*n - 1] = {0, 1, 2, 2, 2, 2, 3, 4, 4, 3, 2, 2, 2, 2, 1, 0, 0, 0, 0};
  ...
  short binaryGray[N][N];
    ...
    Display binaryImage(binaryGray, "Case4Thresholded");
