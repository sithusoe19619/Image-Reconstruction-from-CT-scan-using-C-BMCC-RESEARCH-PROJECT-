...
int main() {
  ...
  int verticalMeasurements[n] = {0, 0, 10, 10, 6, 6, 6, 6, 0, 0};
  ...
  int horizontalMeasurements[n] = {6, 6, 2, 2, 6, 6, 2, 2, 6, 6};
  ...
  int diagonalMeasurements[2*n - 1] = {0, 0, 1, 2, 3, 4, 4, 4, 4, 4, 4, 4, 3, 2, 2, 2, 1, 0, 0};
  ...
  int antiDiagonalMeasurements[2*n - 1] = {0, 0, 1, 2, 3, 4, 4, 4, 4, 4, 4, 4, 3, 2, 2, 2, 1, 0, 0};
  ...
  //Diagonal Reconstruction (index order)
  ...
  //Anti-Diagonal Reconstruction (reverse index so edges align with your desired output)
  ...
  short binaryGray[N][N];
    ...
    Display binaryImage(binaryGray, "Case2Thresholded");
